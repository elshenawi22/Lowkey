...
export default function Drop001Page() {
  ...
  useEffect(() => {
    ...
    import('../utils/meta').then(m => m.setPageMeta(
      'Drop 001 by LOWKEY — A Study in Heritage and Silence. Heritage Knit Polo, Oxford Button-Down, Heavyweight Tee and Merino Crewneck. Crafted in Port Said, Egypt.',
      '/drop/001'
    ));
    return () => {
